            ...
            <div className='relative overflow-hidden '>
                ...
                <div onClick={handleWishListDelete} className='absolute top-[12px] right-[12px]'>
                  ...
                  <button onClick={handleAddToCart}
                   className={`${BtnClass} bottom-0 text-[16px] font-poppins font-medium leading-[24px] text-center py-[8px] bg-black text-white w-full duration-300 absolute  left-0  cursor-pointer`}>Add to Cart</button>
            </div>
